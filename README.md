...
- **Clean Architecture** — domain logic independent of frameworks, databases, and delivery mechanisms
- **SOLID & DDD** — designing around the domain, not the database schema
- **CQRS / Event Sourcing** — separating reads from writes where complexity justifies it
- **12-Factor Apps** — portable, scalable services that are easy to operate and reason about
